...
\toprule
 \multirow{2}{*}{Dane ATSP} & \multirow{2}{*}{Rozmiar} & \multirow{2}{*}{Optimum} & \multicolumn{2}{c}{Greedy} & \multicolumn{2}{c}{Steepest} & \multicolumn{2}{c}{Autorski} & \multicolumn{2}{c}{Losowy} \\
...
\begin{figure}
\begin{center}
\includegraphics[width=0.95\textwidth]{wykresy/greedy2_1}
\end{center}
\caption{Jakoś rozwiązań dla autrskiego rozwiązania w porównaniu
do najlepszych znanych rozwiązań}
\label{fig-3d}
\end{figure}
