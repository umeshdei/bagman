...
void DataSaver::saveOverallLine(string pstrFName, double pdTime, int piSteps,
		int piSeenS, int score)
{
	_WorkingFile << pstrFName << "\t" << fixed << pdTime << "\t" << piSteps
			<< "\t" << piSeenS << "\t" << score << std::endl;
}
